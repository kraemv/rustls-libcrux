...
pub static ALGORITHMS: WebPkiSupportedAlgorithms = WebPkiSupportedAlgorithms {
    ...
    mapping: &[
        ...
        (SignatureScheme::RSA_PKCS1_SHA256, &[AWS_LC_RSA_PKCS1_SHA256]),
    ],
};

static ED25519: &dyn SignatureVerificationAlgorithm = &Verify::<Ed25519PublicKey>::new();

static ECDSA_P256_SHA256: &dyn SignatureVerificationAlgorithm = &Verify::<EcDsaP256PublicKey<SHA256>>::new();
...
{   
    ...
    fn signature_alg_id(&self) -> AlgorithmIdentifier {
        match T::SCHEME {
            ...
            LibcruxSignatureScheme::EcDsaP256(ecdsa::DigestAlgorithm::Sha256) => alg_id::ECDSA_SHA256,
            LibcruxSignatureScheme::EcDsaP256(ecdsa::DigestAlgorithm::Sha384) => alg_id::ECDSA_SHA384,
            LibcruxSignatureScheme::EcDsaP256(ecdsa::DigestAlgorithm::Sha512) => alg_id::ECDSA_SHA512,
        }
    }
}
